...
def baseteamsqlinsert():
    ...
    start_date = date(2006, 11, 18)
    dates = []
    
    while 1 != 2:
        new_date = start_date + datetime.timedelta(days=1)
        if new_date != date(2017,4,25):
    ...
    z = 0
    dates.index('2011-2-9')
    #826, 828, 830, 832, 838
    for week in [dates[826], dates[828], dates[830], dates[832], dates[838]]:
        try:
